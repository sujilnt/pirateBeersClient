...
export class ProductsApi extends runtime.BaseAPI {
   ...
   */
  async addProductRaw(
    requestParameters: AddProductRequest,
   ...
   * Deleting products based on product Ids
   */
  async deleteProductsByIdsRaw(
    requestParameters: DeleteProductsByIdsRequest,
    initOverrides?: RequestInit | runtime.InitOverideFunction,
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters.ids === null || requestParameters.ids === undefined) {
      throw new runtime.RequiredError(
        'ids',
        'Required parameter requestParameters.ids was null or undefined when calling deleteProductsByIds.',
      );
    }
   ...
   * Gets all product categories
   */
  async getAllProductCategoriesRaw(
    initOverrides?: RequestInit | runtime.InitOverideFunction,
  ...
  async getCategoryByIdRaw(
    ...
    const response = await this.request(
      {
        path: `/products/categories/{id}`.replace(
          `{${'id'}}`,
  ...
  /**
   * Get product recommendations from diffrent users
   * Get product recommendations from diffrent users
   */
  async getProductRecommendationsRaw(
    initOverrides?: RequestInit | runtime.InitOverideFunction,
  ): Promise<runtime.ApiResponse<Array<Product>>> {
    const queryParameters: any = {};
  ...
  async getProductRecommendations(
    ...
    const response = await this.getProductRecommendationsRaw(initOverrides);
    return await response.value();
  }
}
